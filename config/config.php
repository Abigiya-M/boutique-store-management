...
// Application Configuration (use conditional defines to prevent duplicates)
if (!defined('APP_NAME')) {
    ...
    // Session Configuration (must be before AUTH_SESSION_TIMEOUT)
    ...
    // Authentication Configuration (use SESSION_LIFETIME defined above)
...
if (!defined('ROLES')) {
    ...
    define('CORS_ALLOWED_HEADERS', 'Content-Type, X-CSRF-Token, Authorization');
